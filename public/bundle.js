...
/***/ (function(module, exports, __webpack_require__) {
	...
	svg.each(function (matrix, j) {
	    ...
	    var indicatorGroups = svg.selectAll('g.indicator-group').data(indicatorLayout.groups).enter().append('svg:g').attr('class', 'indicator-group').on('mouseover', fade(0.05)).on('mouseout', fade(0.80));
	    ...
	    // })
	    .style('fill', 'white').style('stroke', 'grey').style('stroke-width', '1').attr('id', function (d, i) {
	    ...
	    var componentGroups = svg.selectAll('g.component-group-main').data(componentLayout.groups).enter().append('svg:g').attr('class', 'component-group-main');
