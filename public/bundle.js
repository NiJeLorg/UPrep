...
/***/ (function(module, exports, __webpack_require__) {
	...
	var chord = d3.layout.chord().padding(.10).sortSubgroups(d3.descending).sortChords(d3.descending);
	
	var fill = d3.scale.category20c();
	
	var arc = d3.svg.arc().innerRadius(innerRadius).outerRadius(innerRadius + 20);
	
	var svg = d3.select('.svg-holder').append('svg').attr('width', outerRadius * 2.5).attr('height', outerRadius * 2.5).append('g').attr('transform', "translate(" + outerRadius + "," + outerRadius + ")");
